...
\definecolor{quotecolor}{RGB}{0,80,148}
\definecolor{addresscolor}{RGB}{0,0,0}
\definecolor{sectionrectanglecolor}{RGB}{0,80,148}
\definecolor{sectiontitlecolor}{RGB}{0,80,148}
\definecolor{subsectioncolor}{RGB}{0,80,148}
...
\cventry{06/2018 -- heute}{Softwareentwickler}{Liebherr Verzahntechnik GmbH}{Kempten}{}
{\begin{itemize}\item süüüüüü \item üüüüüüüüüüüü  \end{itemize}}
%{Entwicklung von Softwarelösungen im Automationsbereich "Bin Picking", Projektleitung und Hauptverantwortlichkeit für 2D- und 3D-Vision Systeme, Projektleitung und Beteiligungen an diversen BMBF-Forschungsprojekten}  % arguments 3 to 6 are optional
...
\cventry{04/2017 -- 11/2017}{Audi Autonomous Driving Cup}{Universität Augsburg}{}{}{Entwicklung von vollautomatischen Fahrfunktionen und die dafür notwendigen Software-Architekturen innerhalb von C++-ADTF-Filtern für Audi-Q2-Modellfahrzeuge %im Maßstab 1:8
}
...
\cvline{Programmiersprachen}{C\# (gut), C++ (gut), Lua(gut), C und Java(grundlegend)}
\cvline{IDEs}{Visual Studio, Unity, CoppeliaSim}
\cvline{Office}{Word, \LaTeX , Powerpoint, Outlook, Excel, Photoshop}
\cvline{Robotik-Kenntnisse}{Fanuc, Kuka}
