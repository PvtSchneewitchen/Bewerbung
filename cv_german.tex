...
\definecolor{quotecolor}{RGB} {253,196,0}
\definecolor{addresscolor}{RGB}{0,0,0}
\definecolor{sectionrectanglecolor}{RGB}{253,196,0}
\definecolor{sectiontitlecolor}{RGB}{253,196,0}
\definecolor{subsectioncolor}{RGB}{253,196,0}
...
{Entwicklung und Wartung der Software LHRobotics.Vision, Projektleitung und Hauptverantwortlichkeit für 2D- und 3D-Vision Systeme, Projektleitung und Beteiligungen an staatlich geförderten Forschungsprojekten}  % arguments 3 to 6 are optional
...
\cvline{Programmiersprachen}{C++ (gut), Lua (gut),C\# und  C und Java (grundlegend)}
\cvline{IDEs}{Visual Studio, Unity, CoppeliaSim, Halcon HDevelop}
\cvline{Office}{Word, \LaTeX , Powerpoint, Outlook, Excel, Photoshop}
\cvline{Robotik-Kenntnisse}{Fanuc und Kuka (grundlegend)}
